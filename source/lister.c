...
static int
find_longest (ARRAY *list, const char * (*fcn)(void *), int cnt)
{
	const char *data;
	int max;
	int len;
...
static int
find_count (ARRAY *list, const char * (*fcn)(void *))
{
	int cnt;
 ...
 **/
int 
display_list_cl(ARRAY *list, const char * (*fcn)(void *), 
 ...
 **/
int
display_list(ARRAY *list, const char * (*fcn)(void *), xformat fmt)
{
 ...
 **/
int
display_list_c(ARRAY *list, const char * (*fcn)(void *), xformat fmt, int count)
{
	int longest = find_longest(list, fcn, count);
 ...
 **/
int
display_list_l(ARRAY *list, const char * (*fcn)(void *), xformat fmt, int longest)
{
	int count = find_count(list, fcn);
