...
void 
do_log (int flag, char *logfile, FILE ** fp)
{
	time_t t = time (NULL);
...
void 
logger (Window * win, char *unused, int flag)
{
	char *logfile;
 ...
 */
void 
set_log_file (Window * win, char *filename, int unused)
{
	char *expanded;
 ...
 */
void 
add_to_log (FILE * fp, time_t t, const char *line)
{
	if (fp)
	{
